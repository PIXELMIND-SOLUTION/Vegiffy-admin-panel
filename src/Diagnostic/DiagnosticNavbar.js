...
const DiagnosticNavbar = ({ setIsCollapsed, isCollapsed }) => {
  const navigate = useNavigate();

  const handleProfile = () => {
    navigate("/diagnostic/profile");
  };

  const handleBookings = () => {
    navigate("/diagnostic/all-bookings");
  };
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="flex flex-col justify-center items-center">
            <img
              ...
              alt="Diagnostic Logo"
            />
            <h1 className="text-xs font-medium">Diagnostic</h1>
          </div>
        </div>
      </div>
    </nav>
